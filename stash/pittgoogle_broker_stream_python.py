...
from pittgoogle_subscriber_client import PittGoogleSubscriber


PITTGOOGLE_URL_STUB = "https://pubsub.googleapis.com"
...
class PittGoogleBrokerStream(GenericBroker):
    ...
    def __init__(self):
        ...
        self.stream = PittGoogleSubscriber(SUBSCRIPTION_NAME)
